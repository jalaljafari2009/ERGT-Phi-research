...
def main():
    ...
    out=ROOT/'runs/m2_information'; out.mkdir(parents=True,exist_ok=True); run=ROOT/'runs/imported_m0/m0_single_seed_reference'
    ...
    (out/'result.json').write_text(json.dumps(result,indent=2)); (ROOT/'manifests/m2_information.json').write_text(json.dumps(result,indent=2))
