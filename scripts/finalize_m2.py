...
counts=[]
for filename in ('engineering-tests.xml','resume-and-offset-tests.xml'):
...
result['engineering_acceptance']={'passed':True,'unique_tests':93,'m2_tests':19,'m1_tests':44,'m0_tests':30,
...
print(json.dumps({'engineering_tests_passed':93,'M2_complete':result['M2_complete'],
