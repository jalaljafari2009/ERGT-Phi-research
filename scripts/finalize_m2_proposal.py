...
import hashlib,json
ROOT=Path(__file__).resolve().parents[1];OUT=current_input(ROOT, "runs/m2_proposal")
...
(workspace_path(ROOT, "manifests/m2_proposal.json")).write_text(json.dumps(r,indent=2))
