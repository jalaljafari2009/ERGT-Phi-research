...
**تغییر v004:** پس از دو اصلاح بسته‌بندی، v003 پیش از model evaluation نشان داد عرض no-phase باید ۳۵ باشد تا اختلاف ظرفیت زیر ۱٪ بماند. v004 فقط این حساب را اصلاح می‌کند؛ داده، checkpoint، seed، gate و بودجه ثابت‌اند.
...
- قرارداد اجرا: [`configs/m2_fresh_v2.json`](../../../../configs/m2_fresh_v2.json)؛
...
اجرای package-bound محلی `20260921T224500Z-m2e003-v004-local` هر ۲۲ gate را پاس کرد.
phase در دو پنجره balanced accuracy برابر `0.7800283` و `0.7711597` داشت؛ Q-only و
no-phase هم‌ظرفیت در هر دو پنجره `1.0` ثبت کردند. [تفسیر](runs/20260921T224500Z-m2e003-v004-local/interpretation.md)
و [ADR-0011](../../../decisions/ADR-0011.md) دامنهٔ نتیجه را ثبت می‌کنند: تعمیم
کالیبراسیون پذیرفته شد، ولی سود اختصاصی فاز در این target کمکی پشتیبانی نشد. M3 بسته است.
