...
Experiment: `M2-E003/v002` · stage `M2` · kind `research`.
...
**تغییر v002:** فقط مسیر بسته‌بندی قفل cohort اصلاح شد؛ فایل قفل byte-identical است و هیچ seed، داده، checkpoint، کنترل، gate یا بودجه‌ای تغییر نکرد. v001 پیش از model evaluation شکست خورد.
...
[قفل توسعهٔ تازه](fresh_development_lock.json) ثبت شده است.
