...
اجرای package-bound محلی `20260922T072000Z-m2e004-v001-local` هر ۲۰ gate را پاس
کرد. Q-only پس از Q-zero به ۱/۳ و پس از permutation به صفر رسید؛ raw-only نزدیک شانس
بود. relation sequence در جفت‌هایی که پاسخ عوض می‌شد ثابت ماند. پنل native پاسخ/مسیر
در این cohort سقف کامل ۱٫۰ داشت و برای مقایسهٔ phase تمایزبخش نبود. [تفسیر](runs/20260922T072000Z-m2e004-v001-local/interpretation.md)
و [ADR-0012](../../../decisions/ADR-0012.md) دامنه و اقدام بعد را ثبت می‌کنند. M3 و M8 بسته‌اند.
