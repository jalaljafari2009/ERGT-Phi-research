...
4. **پیش‌ثبت و پیاده‌سازی شد — ۲۲ سپتامبر ۲۰۲۶:** `M2-E003/v002` checkpoint منجمد
   را بدون تنظیم مجدد روی دو پنجرهٔ توسعهٔ تازه، pair/text-disjoint و در برابر Q-only
   و no-phase هم‌ظرفیت می‌سنجد. v001 پیش از محاسبه به‌علت نقص بسته‌بندی revise شد؛
   runner/نوت‌بوک v002 آماده‌اند و نتیجه هنوز وجود ندارد.
