...
4. **پیش‌ثبت و پیاده‌سازی شد — ۲۲ سپتامبر ۲۰۲۶:** `M2-E003/v003` checkpoint منجمد
   ...
   بستهٔ ناقص داشت؛ runner/نوت‌بوک v003 با همان طراحی آماده‌اند و نتیجه هنوز وجود ندارد.
