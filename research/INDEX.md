...
| تأیید توسعهٔ تازهٔ M2-Q | [M2-E003/v003](experiments/M2-E003/v003/README.md)، [قفل cohort و پنجره‌ها](../configs/m2_e003_fresh_development_lock.json)، [شکست بسته‌بندی v001](experiments/M2-E003/v001/runs/20260921T221000Z-m2e003-local/interpretation.md)، [ADR-0009](decisions/ADR-0009.md)؛ v003 آماده و هنوز اجرا نشده |
