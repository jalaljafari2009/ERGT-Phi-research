...
| تأیید توسعهٔ تازهٔ M2-Q | [M2-E003/v004](experiments/M2-E003/v004/README.md)، [قفل cohort و پنجره‌ها](../configs/m2_e003_fresh_development_lock.json)، [شکست ظرفیت v003](experiments/M2-E003/v003/runs/20260921T222500Z-m2e003-v003-local/interpretation.md)، [ADR-0010](decisions/ADR-0010.md)؛ v004 آماده و هنوز اجرا نشده |
