...
| تأیید توسعهٔ تازهٔ M2-Q | [M2-E003/v002](experiments/M2-E003/v002/README.md)، [قفل cohort و پنجره‌ها](experiments/M2-E003/v002/fresh_development_lock.json)، [شکست بسته‌بندی v001](experiments/M2-E003/v001/runs/20260921T221000Z-m2e003-local/interpretation.md)، [ADR-0008](decisions/ADR-0008.md)؛ v002 آماده و هنوز اجرا نشده |
