...
این دفتر مشخص می‌کند چه چیزی با کدام شاهد قابل گفتن است. «مشاهدهٔ اکتشافی»، «پذیرش مهندسی»، «کالیبراسیون کمکی» و «تأیید مستقل پاسخ نهایی» سطوح متفاوت‌اند. CL-001 تا CL-007 شواهد تاریخی‌اند؛ CL-008 اعتبارسنجی زیرساخت، CL-009 تحویل مهندسی M2 و CL-010 تا CL-012 ممیزی‌های توسعه‌ای با محدودیت‌های صریح‌اند. تأیید علمی تازهٔ پاسخ نهایی هنوز وجود ندارد. مرور محدودیت‌ها در [roadmap](../docs/OPERATIONAL_ROADMAP_FA.md) ثبت شده است.
...
| `CL-011` | در ممیزی frozen، Q-zero دقت relation را به حدود شانس و permutation آن را برای Q-only/no-phase به صفر رساند؛ raw-only نزدیک شانس بود. relation در تمام جفت‌ها ثابت ماند، در حالی که پاسخ ۲۲۴ جفت supported عوض شد؛ پس relation target برای ادعای انتخاب پاسخ مناسب نیست | [خلاصه](experiments/M2-E004/v001/runs/20260922T072000Z-m2e004-v001-local/summary.md)، [تفسیر](experiments/M2-E004/v001/runs/20260922T072000Z-m2e004-v001-local/interpretation.md)، [بازبینی](experiments/M2-E004/v001/runs/20260922T072000Z-m2e004-v001-local/reviews/001.json)، [ADR-0012](decisions/ADR-0012.md) | پنل native همین cohort روی answer/path سقف ۱٫۰ داشت؛ target margin/challenge بعدی لازم است. gold leakage، مزیت Phase، M3 و M8 نتیجه نمی‌شوند |
| `CL-012` | در پنل frozen challenge، intervention در هر پنجره ۱۹۲/۲۵۲ پاسخ را خراب و افت margin متمایز ایجاد کرد، اما event-chain و path degradation هر دو صفر بودند؛ پس پنل فعلی challenge پاسخ است و challenge مسیر نیست | [خلاصه](experiments/M2-E005/v002/runs/20260922T104000Z-m2e005-v002-local/summary.md)، [تفسیر](experiments/M2-E005/v002/runs/20260922T104000Z-m2e005-v002-local/interpretation.md)، [بازبینی](experiments/M2-E005/v002/runs/20260922T104000Z-m2e005-v002-local/reviews/001.json)، [ADR-0014](decisions/ADR-0014.md) | readout Phase توصیفاً بهتر بود، ولی Phase-zero/permute هم‌اندازه یا بهتر شد؛ برتری Phase، وابستگی به relation-Q، بهبود native، M3 و M8 نتیجه نمی‌شوند |
